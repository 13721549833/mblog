...
import com.mtons.mblog.modules.rabbitmq.EmailMqMessage;
...
public class EmailController extends BaseController {
    ...
    public Result sendCode(String email, @RequestParam(name = "type", defaultValue = "1") Integer type) {
        ...
        // 异步发送邮件
        // 发送消息
        amqpTemplate.convertAndSend(RabbitConstant.EMAIL_EXCHAGE, RabbitConstant.EMAIL_ROUTING_KEY,
                new EmailMqMessage(email, title, Consts.EMAIL_TEMPLATE_CODE, context));
        log.info("EmailController...send_code...验证码{}", code);
