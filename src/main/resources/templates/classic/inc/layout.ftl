...
<head>
    ...
    <link href="${base}/dist/css/photo.css" rel="stylesheet"/>
    ...
    <script type="text/javascript" src="${base}/dist/js/mootools-core.js"></script>
    <script type="text/javascript" src="${base}/dist/js/mediabox.js"></script>
